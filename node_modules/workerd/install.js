...
function installUsingNPM(pkg, subpath, binPath) {
  ...
  try {
    ...
    import_child_process.default.execSync(
      `npm install --loglevel=error --prefer-offline --no-audit --progress=false ${pkg}@${"1.20260205.0"}`,
...
async function downloadDirectlyFromNPM(pkg, subpath, binPath) {
  ...
  const url = `https://registry.npmjs.org/${pkg}/-/${unscopedPkg}-${"1.20260205.0"}.tgz`;
